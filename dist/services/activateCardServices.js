...
function validateCvc(securityCode, cvc) {
    ...
    var ans = cryptr.decrypt(securityCode);
    if (ans !== cvc) {
        throw {
            status: 401,
...
function insertData(id, passCrypt) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, repositories.update(id, passCrypt)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
export { validateCvc, encryptPassword, insertData };
