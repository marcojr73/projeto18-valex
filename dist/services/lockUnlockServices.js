...
function validatePass(passCrypt, password) {
    ...
    var ans = cryptr.decrypt(passCrypt);
    if (ans != password) {
        throw {
            status: 401,
...
function validateBlocked(card, aux) {
    var message = "this card is already unlocked";
    if (aux) {
...
function blockCard(id, aux) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, repositoriesCard.block(id, aux)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
export { validatePass, validateBlocked, blockCard };
